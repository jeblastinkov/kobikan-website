...
export const BLOG_I18N = {
  sk: {
    ...
    read: "min čítania",
    backToSite: "Späť na KobiKan",
    readFull: "Čítať celý článok",
    pillar: "Sprievodca",
    back: "Späť na blog",
    ...
    notFound: "Článok sa nenašiel.",
  },
  en: {
    metaTitle: "Blog — KobiKan: AI in industrial maintenance",
    metaDescription:
  ...
  ja: {
    metaTitle: "ブログ — KobiKan：産業保全のためのAI",
    metaDescription:
      "製造業と保全におけるAIの実践記事。導入、ダウンタイム削減、技術者の知識継承、PLC連携について解説します。",
    journal: "KobiKanジャーナル",
    title: "産業保全のためのAI",
    sub: "設備停止を減らし、技術者の知識を継承したい保全チームのための実践記事です。",
    read: "分で読めます",
    backToSite: "KobiKanに戻る",
    readFull: "記事を読む",
    pillar: "導入ガイド",
    back: "ブログに戻る",
    related: "関連記事",
    cta: "デモを予約",
    ctaSub: "お客様の設備でKobiKanをご体験ください。",
    home: "KobiKan",
    breadcrumbHome: "ホーム",
    stickyMsg: "この記事はいかがでしたか？",
    author: "KobiKanチーム · Touch4IT",
    notFound: "記事が見つかりませんでした。",
  },
} as const;

export type BlogUiLang = keyof typeof BLOG_I18N;
